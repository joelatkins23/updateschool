        ...
        <div class="x_panel">
            ...
            <div class="x_content"> 
                ...
                <div class="row"> 
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-12">
                        <div class="item form-group"> 
                            <div><?php echo $this->lang->line('semester'); ?>  <span class="required">*</span></div>
                            <select  class="form-control col-md-7 col-xs-12" name="semester_id" id="semester_id"  required="required">
                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                <?php foreach ($semesters as $obj) { ?>
                                <option value="<?php echo $obj->id; ?>" <?php if(isset($semester_id) && $semester_id == $obj->id){ echo 'selected="selected"';} ?>><?php echo $obj->name; ?></option>
                                <?php } ?>
                            </select>
                            <div class="help-block"><?php echo form_error('semester_id'); ?></div>
                        </div>
                    </div>  
                    <div class="col-md-3 col-sm-3 col-xs-12">
                        <div class="item form-group"> 
            ...
            <div class="x_content">
                ...
                <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                    ...
                    <tbody id="fn_result">   
                        ...
                        if (isset($students) && !empty($students)) {
                            ...
                            $result = get_exam_semester_result($school_id, $exam_id, $obj->id, $academic_year_id,  $class_id, $semesters_id, $section_id ); 
                ...
                <div class="form-group">
                    <div class="col-md-6 col-md-offset-5">
                        ...
                        <input type="hidden" value="<?php echo isset($semester_id) ? $semester_id : ''; ?>"  name="semester_id" />
