                    ...
                    <div class="col-md-2 col-sm-4 col-xs-6">
                        <div class="item form-group"> 
                            ...
                            <select  class="form-control col-md-7 col-xs-12" name="subject_id" id="subject_id">
                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                <?php foreach ($subject as $obj) { ?>
                                <option value="<?php echo $obj->id; ?>" <?php if(isset($subject_id) && $subject_id == $obj->id){ echo 'selected="selected"';} ?>><?php echo $obj->code; ?></option>
                                <?php } ?>                          
                            </select>
                        </div>
                    </div>
                ...
                <table id="datatable-responsive" class="table table-striped_ table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                    <thead>
                        <tr >
                            ...
                            <th class="text-center" rowspan="2">Nº Proc.</th>
                            <th class="text-center" rowspan="2">Nome Completo</th>
                            <th class="text-center" colspan="4" >IIº SEMESTRE</th>                                            
                            <th class="text-center" rowspan="2">CA</th>                                            
                            <th class="text-center" rowspan="2">EXAME</th> 
                            <th class="text-center" rowspan="2">ORAL</th> 
                            <th class="text-center" rowspan="2">RECURSO</th>                                            
                            <th class="text-center" rowspan="2">CF</th>                                            
                            <th class="text-center" rowspan="2">OBS</th>
                        </tr>
                        <tr class="text-center">
                            <th class="text-center">MAS</th>
                            <th class="text-center">CPF1</th>
                            <th class="text-center">CPF2</th>
                            <th class="text-center">CS2</th>    
                        </tr>
                    </thead>                     
                </table>                
            </div>
