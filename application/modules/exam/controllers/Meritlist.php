...
class Meritlist extends MY_Controller {
    ...
    * ********************************************************** */
    public function index() {
        ...
        $this->data['subject'] =$this->merit->get_list('subjects',  array('school_id'=>$school_id), '','', '', 'id', 'ASC');
        $this->data['exams'] = $this->merit->get_list('exams', $condition, '', '', '', 'id', 'ASC');
        $this->data['courses']=$this->merit->get_list('courses', array('school_id'=>$school_id), '','', '', 'id', 'ASC');
