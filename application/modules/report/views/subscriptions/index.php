...
@media print{
    ...
    .table-blank-bordred>tbody>tr>td, .table-blank-bordred>tbody>tr>th, .table-blank-bordred>tfoot>tr>td, .table-blank-bordred>tfoot>tr>th, .table-blank-bordred>thead>tr>td, .table-blank-bordred>thead>tr>th {
        border: 1px solid #000 !important;
    }
}
</style>
                ...
                <div class="" data-example-id="togglable-tabs">
                           ...
                           <div class="col-sm-6  col-xs-6 layout-box">
                               <div>
                                 ...
                                 <?php } ?>
                                   ...
                                   <h3 class="head-title ptint-title" style="width: 100%;"><i class="fa fa-bar-chart"></i><small> <?php echo $this->lang->line('list'); ?> <?php echo $this->lang->line('subscriptions'); ?> <?php echo $this->lang->line('report'); ?></small></h3>                
                    ...
                    <div class="tab-content">
                        <div  class="tab-pane fade in active" id="tab_tabular" >
                            <div class="x_content">
                            <table  class="datatable-responsive table table-striped table-blank-bordred table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
