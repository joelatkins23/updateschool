                ...
                <div class="row">    
                   ...
                   <div class="col-md-offset-3 col-md-2 col-sm-offset-3 col-sm-2 col-xs-offset-3 col-xs-12">
                        <div class="item form-group"> 
                            ...
                            <input type="text" class="form-control col-md-7 col-xs-12" id="start_date" name="start_date" value="<?php echo $data_hoje; ?>" placeholder="<?php echo $this->lang->line('start_date'); ?>" autocomplete="off" required="required">
                        </div>
                    </div>
                    <div class="col-md-2 col-sm-2 col-xs-12">
                        <div class="item form-group"> 
                            <?php echo $this->lang->line('end_date'); ?> <span class="required">*</span>
                            <input type="text" class="form-control col-md-7 col-xs-12" id="end_date" name="end_date" value="<?php echo $data_hoje; ?>" placeholder="<?php echo $this->lang->line('end_date'); ?>" autocomplete="off" required="required">
                        </div>
                    </div>                   
                ...
                <div class="" data-example-id="togglable-tabs">
                           ...
                           <div class="col-sm-6 col-xs-6">
                               <div>
                                 ...
                                 <?php } ?>
                                   ...
                                   <div>NIF:<?php echo $school->school_fax; ?></div>
                                    <div>RUA:<?php echo $school->address; ?></div>
                                    <div>TELE:<?php echo $school->phone; ?></div>
                    ...
                    <div class="tab-content">
                        <div  class="tab-pane fade in active" id="tab_tabular" >
                                <h4 class="text-center">MOVIMENTOS DIÁRIO</h4>
