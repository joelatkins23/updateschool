                ...
                <div class="" data-example-id="togglable-tabs">
                               ...
                               <div>
                                 ...
                                 <?php } ?>
                                   ...
                                   <div>NIF:<?php echo $school->school_fax; ?></div>
                                    ...
                                    <div>TEL:<?php echo $school->phone; ?></div>
                    ...
                    <div class="tab-content">
                        <div  class="tab-pane fade in active" id="tab_tabular" >
                                <h4 class="text-center">Propinas Não Pagas</h4>
                                <div class="text-center">De:<?php echo $start_date = '2020-10-01'; ?>&nbsp;&nbsp;a:<?php echo $end_date;?></div>
                            <div class="x_content">
                            <table id="datatable-keytable" class="datatable-responsive table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th><?php echo $this->lang->line('delay'); ?> <?php echo $this->lang->line('month'); ?></th>                                        
                                ...
                                <div class="col-md-4" style="width:33.3%">
                                    <table  class="" cellspacing="0" width="100%">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td  width="50%" class="text-right red"><strong><?php echo $this->lang->line('total'); ?> <?php echo $this->lang->line('unpaid'); ?> :</strong></td>
