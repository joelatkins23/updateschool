...
class Report extends My_Controller {
    ...
    * ********************************************************** */
    ...
    public function listadmit() {
        ...
        if ($_POST) {
            ...
            $this->data['admitlist'] = $this->report->get_admit_student_course_report($school_id, $academic_year_id,$course_id,$period, $class_id,$section_id);
    ...
    * ********************************************************** */
    public function studentnotpayment() {
        ...
        $this->data['view']=TRUE;
        $this->data['school'] = $this->report->get_school_by_id($school_id);            
        $this->data['allnotpaymentlist'] = $this->report->get_student_not_report($start_date,$end_date,$classe);
        $this->data['start_date']=$start_date;
        $this->data['end_date']=$end_date;
        $this->data['class']=$classe;
        $this->data['periodo']=$periodo;
        $this->data['turma']=$end_date;
