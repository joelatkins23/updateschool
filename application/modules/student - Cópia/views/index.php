                                    ...
                                    <?php  $count = 1; if(isset($students) && !empty($students)){ ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php } ?>
                                               <?php if(has_permission(VIEW, 'student', 'student')){ ?>
                                                        <a href="javascript:void(0);" onclick="get_student_modal(<?php echo $obj->id; ?>);"  data-toggle="modal" data-target=".bs-student-modal-lg" class="btn btn-success btn-xs"><i class="fa fa-eye"></i> <?php echo $this->lang->line('view'); ?> </a><br/>
                                                    <?php } ?>
...
<script type="text/javascript">
    ...
    function get_print_modal(student_id){
         ...
         $.ajax({       
           type   : "POST",
           url    : "<?php echo site_url('student/get_single_student_print'); ?>",
           data   : {student_id : student_id},  
           success: function(response){                                                   
              if(response)
              {
