<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h3 class="head-title"><i class="fa fa-users"></i><small> <?php echo $this->lang->line('student_exam'); ?></small></h3>
            ...
            <div class="x_content quick-link">
                ...
                <?php if(has_permission(ADD, 'student', 'student')){ ?>
                 ...
                 <?php } ?>
                <?php if(has_permission(VIEW, 'student', 'student')){ ?>
                   | <a href="<?php echo site_url('student/exam'); ?>"><?php echo $this->lang->line('student_exam'); ?></a>                    
                 <?php } ?>
