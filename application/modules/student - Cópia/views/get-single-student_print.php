    ...
    <div class="container">
        <div class="row">
                <div class="admission-form" >
                  <table width="1200px" style="margin:auto;margin-top:80px;">
                        <tr>
                            <td width="20%">&nbsp;</td>
                        ...
                        <tr>
                            ...
                            <td width="60%" class="text-center">
                                <div><h3><?php echo $school->school_name; ?>
								<div><h4>NIF:<?php echo $school->TaxRegistrationNumber; ?></h4></div> 
								<div><h4>Telef.:<?php echo $school->phone; ?></h4></div>
							  <div><h4><?php echo $school->address; ?></h4></div>
                                <div><h4>Email:<?php echo $school->email; ?></h4></div>
                    ...
                    <table width="1000px" style="margin:auto;margin-bottom: 100px;">
                        <tr  >
                            <td  >
                                <p class="admission-form-title" style="margin-right:0px;"><strong><span class="admission-form-title1" style="margin-right:0px;"><strong><?php echo $this->lang->line('information'); ?></strong></span> <?php echo $this->lang->line('basic'); ?>:</strong></p>
                            
                            </td>
                            <td >
                                <p class="admission-form-title text-right" class="text-right" ><strong><?php echo "Matrícula "; ?> nº: &nbsp;<?php echo $student->id; ?>&nbsp;</strong></p>
                        ...
                        <tr>
                            <td width="50%">
                                <div class="form-field">
                                    <div class="field-title"><?php echo $this->lang->line('sector'); ?>:</div> 
                        ...
                        <tr>
                            <td colspan="2">
                                <p class="admission-form-title"><strong><span class="admission-form-title1"><strong><?php echo $this->lang->line('information'); ?> </strong></span><?php echo $this->lang->line('contact'); ?>:</strong></p>
                            </td>
                        </tr>
                        <tr>
                            <td width="50%">
                        ...
                        <tr>
                            <td width="50%">
                                <div class="form-field">
                                    <div class="field-title"><?php echo $this->lang->line('address'); ?> <?php echo $this->lang->line('present'); ?>:</div> 
                                    <div class="field-value"><?php echo $student->present_address; ?></div> 
                                </div>
                            </td>
                            <td width="50%">
                                <div class="form-field">
                                    <div class="field-title"><?php echo $this->lang->line('address'); ?>:</div> 
                        ...
                        <tr>
                            <td colspan="2">
                                ...
                                <strong><span class="admission-form-title1"><strong><?php echo $this->lang->line('information'); ?></strong></span> <?php echo $this->lang->line('academic'); ?>:</strong>
                        ...
                        <tr>
                            ...
                            <td width="50%">
                                <div class="form-field">
                                    <div class="field-title">Lígua de Opção:</div> 
                        ...
                        <tr>
                            ...
                            <td width="50%">
                                <div class="form-field">
                                    <div class="field-title"><?php echo $this->lang->line('course'); ?>:</div> 
                        ...
                        <tr>
                            <td colspan="2">
                                <p class="admission-form-title"><strong><span class="admission-form-title1"><strong><?php echo $this->lang->line('information'); ?></strong></span> <?php echo $this->lang->line('school'); ?><span class="admission-form-title1"><strong> <?php echo $this->lang->line('previous'); ?></strong></span>:</strong></p>
                            </td>
                        </tr>
                        <tr>
                            <td width="50%">
                                <div class="form-field">
                                    <div class="field-title"><?php echo $this->lang->line('school'); ?> <?php echo $this->lang->line('previous'); ?>:</div> 
                                    <div class="field-value"><?php echo $student->previous_school; ?></div> 
                                </div>
                            </td>
                            <td width="50%">
                                <div class="form-field">
                                    <div class="field-title"><?php echo $this->lang->line('class'); ?> <?php echo $this->lang->line('previous'); ?>:</div> 
                        ...
                        <tr>
                            <td colspan="2">
                                <p class="admission-form-title"><strong><span class="admission-form-title1"><strong><?php echo $this->lang->line('information'); ?> do</strong></span><?php echo $this->lang->line('father'); ?>:</strong></p>
                            </td>
                        </tr>
                        <tr>
                            <td width="50%">
                        ...
                        <tr>
                            <td width="50%">
                                <div class="form-field">
                                    <div class="field-title"><?php echo $this->lang->line('education'); ?>:</div> 
                        ...
                        <tr>
                            <td width="50%">
                                <div class="form-field">
                                    <div class="field-title"><?php echo $this->lang->line('designation'); ?>:</div> 
                        ...
                        <tr>
                            <td colspan="2">
                                <p class="admission-form-title"><strong><span class="admission-form-title1"><strong><?php echo $this->lang->line('information'); ?> da <?php echo $this->lang->line('mother'); ?>:</strong></p>
                            </td>
                        </tr>
                        <tr>
                            <td width="50%">
                        ...
                        <tr>
                            <td colspan="2">
                                <p class="admission-form-title"><strong><span class="admission-form-title1"><strong><?php echo $this->lang->line('information'); ?> do <?php echo $this->lang->line('guardian'); ?>:</strong></p>
                            </td>
                        </tr>
                        <tr>
                            <td width="50%">
                        ...
                        <tr>
                            ...
                            <td width="50%">
							  ...
							  <td width="50%">
                                <div class="form-field">
                                    <div class="field-title"><?php echo "User" ?>:</div> 
                                    <div class="field-value"><?php echo $users->username; ?></div>   
                                </div>
                            </td>
                        </tr> 
						<td whidth="30%">&nbsp;</td>
          ...
          <tr>
            <td whidth="30%">Estudante</td>
            <td whidth="30%">Operador: </td>
          </tr>
          <tr>
            <td whidth="30%">________________________________________________________</td>
            <td whidth="30%">________________________________________________________</td>
          </tr>
          <tr>
            <td whidth="30%">&nbsp;</td>
            <td align="left" whidth="30%"><?php echo $student->created_at;  ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <?php echo $this->session->userdata('username');  ?></td>
                    </table>
