    ...
    * ********************************************************** */
    public function index() {
        ...
        if ($_POST) {
            ...
            $this->data['students'] = $this->Aptitudenote_Model->get_student_list($school_id,$school->academic_year_id,$student_id,$exam_id,$course_id,$class_id,$section_id, $period);
            ...
            $this->data['alldata'] = $this->Aptitudenote_Model->get_exam_history($school_id, $school->academic_year_id, $exam_id,$course_id,$class_id,$section_id);
        ...
        if ($_POST) {            
            ...
            if (!empty($_POST['students'])) {
                ...
                foreach ($_POST['students'] as $key => $value) {            
                    $student_id=$value;
                    $studentinfo = $this->Aptitudenote_Model->get_student_list($school_id,$school->academic_year_id, $student_id, $exam_id,$course_id,$class_id,$section_id,$period);
                ...
                $this->data['students'] = $this->Aptitudenote_Model->get_student_list($school_id, $school->academic_year_id, "",$exam_id,$course_id,$class_id,$section_id,$period);       
            }
