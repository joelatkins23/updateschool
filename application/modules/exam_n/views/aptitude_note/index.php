                ...
                <div class="row">
                    <div class="col-sm-4  col-sm-offset-4 layout-box">
                        <p>
                            ...
                            <div><strong style="color:red"><?php echo $this->lang->line('class'); ?>:</strong><?php echo $class_name; ?> &nbsp;&nbsp;&nbsp;<strong style="color:red"><?php echo $this->lang->line('section'); ?>:</strong><?php echo $section_name; ?></div>
                        </p>
                    </div>
                </div>            
            </div>
                                                ...
                                                <tbody>   
                                                    ...
                                                    $count = 1; if(isset($data) && !empty($data)){ ?>
                                                        <?php foreach($data as $obj){ ?>
                                                            ...
                                                            <?php $class = ($obj->avg_grade_point>=10) ? 'text_blue': 'text_red';   ?>
                                                            ...
                                                            <td class='<?php echo $class ?>'><?php echo $obj->result_status; ?></td>
                                                            <!-- <td class='text-center'>
                                                            <?php if($obj->avg_grade_point >=10) {  ?>
