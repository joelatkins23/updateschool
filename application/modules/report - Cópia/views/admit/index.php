<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h3 class="head-title"><i class="fa fa-bar-chart"></i><small> <?php echo $this->lang->line('list'); ?> <?php echo $this->lang->line('admit'); ?> <?php echo $this->lang->line('report'); ?></small></h3>                
            ...
            <?php $this->load->view('quick_report'); ?>
             <div class="x_content filter-box  no-print"> 
                <?php echo form_open_multipart(site_url('report/listadmit'), array('name' => 'sbalance', 'id' => 'sbalance', 'class' => 'form-horizontal form-label-left'), ''); ?>
                <div class="row"> 
                           ...
                           <div class="col-sm-6  col-xs-6 layout-box">
                               <div>
                                 ...
                                 <?php } ?>
                                   ...
                                   <h3 class="head-title ptint-title" style="width: 100%;"><i class="fa fa-bar-chart"></i><small> <?php echo $this->lang->line('list'); ?> <?php echo $this->lang->line('admit'); ?> <?php echo $this->lang->line('report'); ?></small></h3>                
                    ...
                    <div class="tab-content">
                        <div  class="tab-pane fade in active" id="tab_tabular" >
                            ...
                            <table id="datatable-keytable" class="datatable-responsive table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
                                        <th width="10%" style="width:10%"><?php echo $this->lang->line('sl_no'); ?></th>
                                        <th width="24%" style="width:24%"><?php echo $this->lang->line('name'); ?></th>
                                        <th width="18%" style="width:18%"><?php echo $this->lang->line('course'); ?> </th>
                                        <th width="8%" style="width:8%"><?php echo $this->lang->line('class'); ?> </th>
                                        <th width="8%" style="width:8%"><?php echo $this->lang->line('section'); ?> </th>
                                        <th width="12%" style="width:12%"><?php echo $this->lang->line('period'); ?></th>                                        
                                    </tr>
                                </thead>
                                <tbody>   
                                    <?php 
                                    $total_balance = 0;                                  
                                    $count = 1; if(isset($admitlist) && !empty($admitlist)){ ?>
                                        <?php foreach($admitlist as $obj){ ?>
                                        <tr>
