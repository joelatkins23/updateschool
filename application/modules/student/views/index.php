                                            ...
                                            <td width="100" nowrap="nowrap">
                                               ...
                                               <?php if(has_permission(VIEW, 'student', 'student')){ ?>
                                                ...
                                                <?php if(has_permission(DELETE, 'student', 'student')){ ?>
                                                    <a href="<?php echo site_url('student/delete/'.$obj->id); ?>" onclick="javascript: return confirm('<?php echo "Deseja Anular este aluno?" ?>');" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i>  </a>
                                                <?php } ?>
                                                <?php if(has_permission(VIEW, 'student', 'student')){ ?>
