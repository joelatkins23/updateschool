                                ...
                                <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap " cellspacing="0" width="100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th width="21"><?php echo $this->lang->line('phone'); ?></th>
                                           <th width="21"><?php echo $this->lang->line('course'); ?></th>
											<th width="21"><?php echo $this->lang->line('period'); ?></th>
                                            <th width="21"><?php echo $this->lang->line('section'); ?></th>
                                            <th width="21"><?php echo $this->lang->line('class'); ?></th>
                                            <th width="15"><?php echo "Matri" ?></th>
                                            <th width="87"><?php echo $this->lang->line('status'); ?> </th>
                                            
                                            <th width="118"><?php echo $this->lang->line('action'); ?></th>                                            
                                        </tr>
                                    </thead>
                                    <tbody>  
                                        ...
                                        <?php  $count = 1; if(isset($students) && !empty($students)){ ?>
                                            ...
                                            <tr>
                                                ...
                                                <td nowrap="nowrap"><?php echo ucfirst($obj->name); ?></td>
                                                <td><?php echo $obj->phone; ?></td>  
												<td nowrap="nowrap"><?php echo ucfirst($obj->course_name); ?></td>
                                                ...
                                                <td align="center" valign="top" nowrap="nowrap">                                               
                                                    <?php if(has_permission(EDIT, 'student', 'subscriptions')){ ?>
                                                        <br/><a href="<?php echo site_url('student/subscriptions/edit/'.$obj->id); ?>" class="btn btn-info btn-xs"><i class="fa fa-pencil-square-o"></i>  </a>
                                                    <?php } ?>                                                
                                                    <?php if(has_permission(DELETE, 'student', 'subscriptions')){ ?>
                                                        <a href="<?php echo site_url('student/subscriptions/delete/'.$obj->id); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('Deseja Anular?'); ?>');" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i>  </a>
                                                    <?php } ?>
