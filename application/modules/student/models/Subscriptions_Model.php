...
class Subscriptions_Model extends MY_Model {
    ...
    public function get_student_list($class_id = null, $school_id = null, $academic_year_id = null){
        ...
        $this->db->select('S.*, SC.school_name, E.roll_no, E.class_id, U.username, U.role_id,  C.name AS class_name, SE.name AS section,SS.result_status, DE.name AS course_name');
