<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h3 class="head-title"><i class="fa fa-bar-chart"></i><small> <?php echo $this->lang->line('list'); ?> Presença <?php echo $this->lang->line('subscriptions'); ?> </small></h3>                
                            ...
                            <table  class="datatable-responsive table table-striped table-blank-bordred table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th width="400"><?php echo 'Assin. Estudante' ?> </th>
                                        <th width="100"><?php echo 'Nota' ?> </th>
