    ...
    <div class="row">                   
        <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <select  class="form-control" name="report" id="report" onchange="get_report_action(this.value);">
                    ...
                    $reports[site_url('report/listsubscriptions')] = $this->lang->line('list') .' '.$this->lang->line('subscriptions') .' '. $this->lang->line('report'); 
                    $reports[site_url('report/listadmit')] = $this->lang->line('list') .' '.$this->lang->line('admit') .' '. $this->lang->line('report'); 
                    ...
                    $reports[site_url('report/studentdailypayment')] = $this->lang->line('student').' '. $this->lang->line('daily').' '. $this->lang->line('payment'); 
                    $reports[site_url('report/studentnotpayment')] = $this->lang->line('student').' '. $this->lang->line('not').' '. $this->lang->line('payment'); 
                    $reports[site_url('report/studentagepayment')] = $this->lang->line('student').' '. $this->lang->line('age').' '. $this->lang->line('payment'); 
