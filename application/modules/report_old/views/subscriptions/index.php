                           ...
                           <div class="col-sm-6  col-xs-6 layout-box">
                               <div>
                                 ...
                                 <?php } ?>
                                   ...
                                   <h3 class="head-title ptint-title" style="width: 100%;"><i class="fa fa-bar-chart"></i><small> <?php echo $this->lang->line('list'); ?> de <?php echo $this->lang->line('subscriptions'); ?> </small></h3>                
