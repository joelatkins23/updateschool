                    ...
                    <div class="tab-content">
                        <div  class="tab-pane fade in active" id="tab_tabular" >
                            ...
                            <table id="datatable-keytable" class="datatable-responsive table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
                                        <th style="width:10%"><?php echo $this->lang->line('sl_no'); ?></th>
                                        <th style="width:18%"><?php echo $this->lang->line('student'); ?> <?php echo $this->lang->line('name'); ?></th>
                                        <th style="width:18%"><?php echo $this->lang->line('course'); ?> </th>
                                        <th style="width:18%"><?php echo $this->lang->line('class'); ?> </th>
                                        <th style="width:18%"><?php echo $this->lang->line('section'); ?> </th>
                                        <th style="width:18%"><?php echo $this->lang->line('period'); ?></th>                                        
                                    </tr>
                                </thead>
                                <tbody>   
                                    <?php 
