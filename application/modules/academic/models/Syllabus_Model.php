...
class Syllabus_Model extends MY_Model {
    ...
    function __construct() {
     ...
     public function get_syllabus_list($class_id = null, $school_id = null){
        ...
        $this->db->select('SY.*,D.name As course_name, SC.school_name, C.name AS class_name, S.name AS subject, AY.session_year');
        ...
        $this->db->join('courses AS D', 'D.id = SY.course_id', 'left');
