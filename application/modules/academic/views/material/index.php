                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control col-md-7 col-xs-12"  name="course_id"  id="edit_course_id" required="required"  >
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option> 
                                            <?php foreach($courses as $obj ){ ?>                                             
                                                <option value="<?php echo $obj->id; ?>" <?php echo isset($material->course_id) && $material->course_id == $obj->id ?  'selected="selected"' : ''; ?>><?php echo $obj->name; ?></option>
                                            <?php } ?> 
                                        </select>
                                        <div class="help-block"><?php echo form_error('course_id'); ?></div>
                                    </div>
...
<script type="text/javascript"> 
    ...
    function get_subject_by_class(class_id, subject_id){ 
        $.ajax({       
            ...
            data   : { school_id:1, class_id : class_id, subject_id : subject_id},               
            async  : false,
            success: function(response){                                                   
               if(response)
               {
