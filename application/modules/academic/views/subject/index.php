                            ...
                            <div class="x_content"> 
                               <?php echo form_open(site_url('academic/subject/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="course_id"><?php echo $this->lang->line('course'); ?> </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control col-md-7 col-xs-12" name="course_id" id="add_course_id" >
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                            <?php if(isset($course) && !empty($course)){ ?>
                                            <?php foreach($course as $key=>$value){ ?>
                                                <option value="<?php echo $key; ?>" <?php echo isset($post['course_id']) && $post['course_id'] == $key ?  'selected="selected"' : ''; ?>><?php echo $value; ?></option>
                                            <?php } ?>
                                            <?php } ?>
                                        </select>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control col-md-7 col-xs-12"  name="course_id"  id="edit_course_id" required="required" >
                                            ...
                                            <option value="<?php echo $obj->id; ?>" <?php if($subject->course_id == $obj->id){ echo 'selected="selected"';} ?>><?php echo $obj->name; ?></option>
                                            <?php } ?>                                            
                                        </select>
                                        <div class="help-block"><?php echo form_error('course_id'); ?></div>
                                    </div>
 ...
 <script type="text/javascript">
    ...
    $('.fn_school_id').on('change', function(){
        ...
        <?php if(isset($subject) && !empty($subject)){ ?>
            ...
            course_id =  '<?php echo $subject->course_id; ?>';
         <?php } ?> 
