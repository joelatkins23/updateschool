...
class Suggestion_Model extends MY_Model {
    ...
    function __construct() {
     ...
     public function get_suggestion_list($class_id = null, $school_id = null, $academic_year_id = null){
        ...
        $this->db->select('SU.*, SC.school_name, E.title AS exam_title, C.name AS class_name, S.name AS subject, AY.session_year,EE.name AS course_name');
        ...
        $this->db->join('courses AS EE', 'EE.id = E.course_id', 'left');
