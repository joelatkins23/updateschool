                                ...
                                <div class="row">
                                    <div class="col-md-6" style="padding:30px 50px;">
                                        ...
                                        <div class="item form-group" id="amount_payable_select">
                                            <label class="control-label  text-left" for=""><?php echo $this->lang->line('amount'); ?>  <?php echo $this->lang->line('payable'); ?> <?php echo $this->lang->line('course'); ?> <?php echo $this->lang->line('fee'); ?></label>
                                            <div class="">
                                    ...
                                    <div class="col-md-6 payment_submit" style="padding:30px 50px;" >
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="">
                                                <input  class="form-control col-md-7 col-xs-12"  name="pay_day"  id="pay_day" value="<?php echo isset($post['pay_day']) ?  $post['pay_day'] : ''; ?>" placeholder="<?php echo $this->lang->line('pay'); ?> <?php echo $this->lang->line('day'); ?>" required="required" type="text" autocomplete="off">
                                            </div>  
                                        </div>                     
