    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title no-print">
                <h3 class="head-title"><i class="fa fa-calculator"></i><small> <?php echo $this->lang->line('payment'); ?> <?php echo $this->lang->line('list'); ?> <?php echo $this->lang->line('by'); ?>  <?php echo $this->lang->line('student'); ?></small></h3>
            ...
            <div class="x_content">
                <div class="" data-example-id="togglable-tabs">
                    <ul  class="nav nav-tabs no-print bordered">
                        <li class="<?php if(isset($list)){ echo 'active'; }?>"><a href="#tab_studentpayment_list"   role="tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-list-ol"></i> <?php echo $this->lang->line('payment'); ?> <?php echo $this->lang->line('list'); ?> <?php echo $this->lang->line('by'); ?>  <?php echo $this->lang->line('student'); ?></a> </li>
                    ...
                    <div class="tab-content">
                        ...
                        <?php echo form_open_multipart(site_url('accounting/studentpaymentday/index'), array('name' => 'result', 'id' => 'result', 'class' => 'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="col-md-3 col-sm-3 col-xs-3">
                                    <div class="item form-group">       
                                        ...
                                        <select  class="form-control select2" name="student_id" id="student_id" style='width:100%'>
                                            <option value="999999">All Students</option>
                                            <?php if(isset($studentlist) && !empty($studentlist)){ ?>
                                                <?php foreach($studentlist as $obj){ ?>                                                                                  
                                                    <option value="<?php echo $obj->id ?>" <?php if(isset($student_id) && $student_id == $obj->id){ echo 'selected="selected"';} ?> ><?php echo $obj->name ?></option>                                           
                                                    <?php } ?>
                                                <?php } ?>
                                        </select>
                                    </div>
                                ...
                                <?php  if (isset($all_student_payment) && !empty($all_student_payment)) { ?>
                                    <table width="100%">
                                        ...
                                        <tr>
                                            ...
                                            <td width="40%"class="text-center background_title" >Student: <strong><?php echo $student_name; ?></strong></td>
                                        </tr>
                                       <tr>
                                            <td colspan="2">NIF:<?php echo $schoolinfo[0]->TaxRegistrationNumber; ?></td>
                                        </tr>
                                        <tr>
                                            <td colspan="2"><?php echo $schoolinfo[0]->address; ?></td>
                                        </tr>
                                        <tr>
                                            <td colspan="2">TELEF:<?php echo $schoolinfo[0]->phone; ?></td>
                                        </tr>
                                        <tr>
                                                ...
                                                <td class="text-center no-print">    
                                                    <?php if($this->session->userdata('role_id')=='1'){ ?>                                            
                                                        <?php if(has_permission(DELETE, 'accounting', 'studentpayment')){ ?>
                                                            <a style="margin-right:10px"  href="<?php echo site_url('accounting/studentpaymentday/delete?id='.$obj->id.'&f='.$start_date.'&t='.$end_date); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('confirm_alert'); ?>');" ><i class="fa fa-trash-o" style="color:red"></i>&nbsp;</a>
                                                        <?php } ?>    
                                                    <?php } ?>   
                                                    <?php if(has_permission(VIEW, 'accounting', 'studentpayment')){ ?>
                                                        <a href="<?php echo site_url('accounting/studentpaymentday/view?id='.$obj->id.'&f='.$start_date.'&t='.$end_date); ?>" onclick="javascript:void(0);" ><i class="fa fa-print" style="color:#0d0ae6"></i>&nbsp;</a>
                                                    <?php } ?>                              
                                                </td>
                        ...
                        <div class="tab-pane fade in active" id="tab_view_studentpayment">
                            <div class="x_content"> 
                                <table width="1000px" height="" border="0" cellpadding="12" cellspacing="" class="" style="margin-right:10px;">
                                    <tr>
                                ...
                                <table width="1000px" height="" border="0" cellpadding="12" cellspacing="" class="">
                                    <tr>
                                        <td width="100%" bgcolor="#FFFFFF">
                                            <center>
                                                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">                                                    
