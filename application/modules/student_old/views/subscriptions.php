<div class="row" >
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h3 class="head-title"><i class="fa fa-users"></i><small> <?php echo $this->lang->line('manage'); ?> <?php echo $this->lang->line('subscriptions'); ?></small></h3>
            ...
            <div class="x_content quick-link  no-print">
                ...
                <?php if(has_permission(ADD, 'student', 'type')){ ?>
                 ...
                 <?php } ?>
                <?php if(has_permission(ADD, 'student', 'subscriptions')){ ?>
                   | <a href="<?php echo site_url('student/add/'); ?>"> <?php echo $this->lang->line('student'); ?> <?php echo $this->lang->line('admit'); ?> </a>
                 <?php } ?>
            ...
            <div class="x_content">
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <ul  class="nav nav-tabs bordered no-print">
                        <li class="<?php if(isset($list)){ echo 'active'; }?>"><a href="#tab_student_list"   role="tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-list-ol"></i> <?php echo $this->lang->line('subscriptions'); ?> <?php echo $this->lang->line('list'); ?></a> </li>
                        <?php if(has_permission(ADD, 'student', 'subscriptions')){ ?>
                            <?php if(isset($edit)){ ?>
                                <li  class="<?php if(isset($add)){ echo 'active'; }?>"><a href="<?php echo site_url('student/subscriptions/add'); ?>"  aria-expanded="false"><i class="fa fa-plus-square-o"></i> <?php echo $this->lang->line('add'); ?> <?php echo $this->lang->line('subscriptions'); ?></a> </li>                          
                             <?php }else{ ?>
                                 <li  class="<?php if(isset($add)){ echo 'active'; }?>"><a href="#tab_add_student"  role="tab"  data-toggle="tab" aria-expanded="false"><i class="fa fa-plus-square-o"></i> <?php echo $this->lang->line('add'); ?> <?php echo $this->lang->line('subscriptions'); ?></a> </li>                          
                             <?php } ?>
                        <?php } ?>
                        <?php if(isset($edit)){ ?>
                            <li  class="active"><a href="#tab_edit_student"  role="tab"  data-toggle="tab" aria-expanded="false"><i class="fa fa-pencil-square-o"></i> <?php echo $this->lang->line('edit'); ?> <?php echo $this->lang->line('subscriptions'); ?></a> </li>                          
                        <?php } ?>
                         
                        <li class="li-class-list">
                            <?php echo form_open(site_url('student/subscriptions'), array('name' => 'filter', 'id' => 'filter', 'class'=>'form-horizontal form-label-left'), ''); ?>
                    ...
                    <div class="tab-content">
                                    ...
                                    <tbody>  
                                        ...
                                        <?php  $count = 1; if(isset($students) && !empty($students)){ ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php  if($obj->photo != ''){ ?>
                                                    <img src="<?php echo UPLOAD_PATH; ?>/student-photo/<?php echo $obj->photo; ?>" alt="" width="30" /> 
                                                    <?php }else{ ?>
                                                    <img src="<?php echo IMG_URL; ?>/default-user.png" alt="" width="30" /> 
                                                    <?php } ?>
                                                </td>
                                                ...
                                                <td>
                                                    <?php  if($obj->result_status == 'approved'){ ?>
                                                        <a href="javascript:void(0);" onclick="move_admint_student(<?php echo $obj->id; ?>)" class="btn btn-success btn-xs"><?php echo $this->lang->line('approved'); ?> </a>
                                                    <?php  }else{ ?>
                                                        <a href="javascript:void(0);" class="btn btn-info btn-xs"><?php echo $this->lang->line('waiting'); ?> </a>  
                                                    <?php  } ?>                                                       
                                                </td>                                                
                                                <td align="center" valign="top">                                               
                                                    <?php if(has_permission(EDIT, 'student', 'subscriptions')){ ?>
                                                        <br/><a href="<?php echo site_url('student/subscriptions/edit/'.$obj->id); ?>" class="btn btn-info btn-xs"><i class="fa fa-pencil-square-o"></i> <?php echo $this->lang->line('edit'); ?> </a>
                                                    <?php } ?>                                                
                                                    <?php if(has_permission(DELETE, 'student', 'subscriptions')){ ?>
                                                        <a href="<?php echo site_url('student/subscriptions/delete/'.$obj->id); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('confirm_alert'); ?>');" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> <?php echo $this->lang->line('delete'); ?> </a>
                                                    <?php } ?>
                                                    <?php if(has_permission(VIEW, 'student', 'subscriptions')){ ?>
                                                        <a href="javascript:void(0);"onclick="get_print_modal(<?php echo $obj->id; ?>);" class="btn btn-default btn-xs"><i class="fa fa-print"></i> <?php echo $this->lang->line('print'); ?> </a>
                                                    <?php } ?>
                                                </td>
                                            </tr>
                                            <?php } ?>
                        ...
                        <div  class="tab-pane fade in <?php if(isset($add)){ echo 'active'; }?>" id="tab_add_student">
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('student/subscriptions/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                               ...
                               <div class="row">                  
                                ...
                                <div class="row"> 
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                     ...
                                     <div class="col-md-3 col-sm-3 col-xs-12">
                                         <div class="item form-group">
                                             <label for="provincial_sector"><?php echo $this->lang->line('provincial'); ?> <?php echo $this->lang->line('sector'); ?> <span class="required">*</span></label>
                                                <select  class="form-control col-md-7 col-xs-12" name="provincial_sector" id="add_provincial_sector" required="required">
                                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                                <?php foreach($provincialsectors as $obj){ ?>
                                                    <option value="<?php echo $obj->id_p; ?>" <?php echo isset($post['provincial_sector']) && $post['provincial_sector'] == $obj->id_p ?  'selected="selected"' : ''; ?>><?php echo $obj->nome_provincias; ?></option>
                                                <?php } ?>
                                                </select>
                                             <div class="help-block"><?php echo form_error('provincial_sector'); ?></div>
                                         </div>
                                     </div>
                                     <div class="col-md-3 col-sm-3 col-xs-12">
                                         <div class="item form-group">
                                            <label  for="dob"><?php echo $this->lang->line('date_of_national_id'); ?> <span class="required">*</span></label>
                                            <input  class="form-control col-md-7 col-xs-12"  name="date_of_national_id"  id="add_date_of_national_id" value="<?php echo isset($post['date_of_national_id']) ?  $post['date_of_national_id'] : ''; ?>" placeholder="<?php echo $this->lang->line('date_of_national_id'); ?>" required="required" type="text" autocomplete="off">
                                            <div class="help-block"><?php echo form_error('date_of_national_id'); ?></div>
                                         </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">                                      
                                     ...
                                     <div class="col-md-3 col-sm-3 col-xs-12">
                                         <div class="item form-group">
                                            <label for="group"><?php echo $this->lang->line('period'); ?> <span class="required">*</span></label></label>
                                            <select  class="form-control col-md-7 col-xs-12" name="period" id="period">
                                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                                <?php $periods = get_period(); ?>
                                                <?php foreach($periods as $key=>$value){ ?>
                                                    <option value="<?php echo $key; ?>" <?php echo isset($post['period']) && $post['period'] == $key ?  'selected="selected"' : ''; ?>><?php echo $value; ?></option>
                                                <?php } ?>
                                            </select>
                                     ...
                                     <div class="col-md-3 col-sm-3 col-xs-12">
                                         <div class="item form-group">
                                             ...
                                             <input  class="form-control col-md-7 col-xs-12"  name="roll_no"  id="roll_no" value="<?php echo isset($post['roll_no']) ?  $post['roll_no'] : ''; ?>" placeholder="<?php echo $this->lang->line('roll_no'); ?>"  type="text" autocomplete="off">
                                     ...
                                     <div class="col-md-3 col-sm-3 col-xs-12">
                                         <div class="item form-group">
                                            <label for="course_id"><?php echo $this->lang->line('course'); ?> <span class="required">*</span></label></label>
                                            <select  class="form-control col-md-7 col-xs-12 quick-field" name="course_id" id="add_course_id">
                                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                        ...
                        <div class="tab-pane fade in active" id="tab_edit_student">
                            <div class="x_content"> 
                            <?php echo form_open_multipart(site_url('student/subscriptions/edit/'. $student->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                               ...
                               <div class="row">                  
                                ...
                                <div class="row"> 
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                     ...
                                     <div class="col-md-3 col-sm-3 col-xs-12">
                                         <div class="item form-group">
                                             <label for="type_id"><?php echo $this->lang->line('provincial'); ?> <?php echo $this->lang->line('sector'); ?> <span class="required">*</span></label>
                                                <select  class="form-control col-md-7 col-xs-12" name="provincial_sector" id="edit_provincial_sector" required="required">
                                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                                <?php foreach($provincialsectors as $obj){ ?>
                                                    <option value="<?php echo $obj->id_p; ?>" <?php echo isset($student) && $student->provincial_sector == $obj->id_p ?  'selected="selected"' : ''; ?>><?php echo $obj->nome_provincias; ?></option>
                                                <?php } ?>
                                                </select>
                                             <div class="help-block"><?php echo form_error('provincial_sector'); ?></div>
                                         </div>
                                     ...
                                     <div class="col-md-3 col-sm-3 col-xs-12">
                                         <div class="item form-group">
                                            <label  for="dob"><?php echo $this->lang->line('date_of_national_id'); ?> <span class="required">*</span></label>
                                            <input  class="form-control col-md-7 col-xs-12"  name="date_of_national_id"  id="edit_date_of_national_id" value="<?php echo isset($student->date_of_national_id) ?  date('d-m-Y', strtotime($student->date_of_national_id)) : ''; ?>" placeholder="<?php echo $this->lang->line('date_of_national_id'); ?>" required="required" type="text" autocomplete="off">
                                            <div class="help-block"><?php echo form_error('date_of_national_id'); ?></div>
                                         </div>
                                    </div>                                    
                                </div>
                                ...
                                <div class="row">                                      
                                     ...
                                     <div class="col-md-3 col-sm-3 col-xs-12">
                                         <div class="item form-group">
                                            ...
                                            <select  class="form-control col-md-7 col-xs-12" name="period" id="period">
                                                ...
                                                <?php $periods = get_period(); ?>
                                                <?php foreach($periods as $key=>$value){ ?>
                                                    <option value="<?php echo $key; ?>" <?php if($student->period == $key){ echo 'selected="selected"';} ?>><?php echo $value; ?></option>
                                                <?php } ?>
                                            </select>
                                            <div class="help-block"><?php echo form_error('period'); ?></div>
                                         </div>
                                     ...
                                     <div class="col-md-3 col-sm-3 col-xs-12">
                                         <div class="item form-group">
                                             <label for="roll_no"><?php echo $this->lang->line('roll_no'); ?> </label>
                                             <input  class="form-control col-md-7 col-xs-12"  name="roll_no"  id="roll_no"  value="<?php echo isset($student->roll_no) ?  $student->roll_no : ''; ?>" placeholder="<?php echo $this->lang->line('roll_no'); ?>" type="text" autocomplete="off">
                                             <div class="help-block"><?php echo form_error('roll_no'); ?></div>
                                         </div>
                                     </div>
                                </div>
                                ...
                                <div class="row">                                        
                                     <div class="col-offset-md-9 col-md-3 col-offset-sm-9 col-sm-3 col-xs-12">
                                         <div class="item form-group">
                                            <label for="course_id"><?php echo $this->lang->line('course'); ?> <span class="required">*</span></label></label>
                                            <select  class="form-control col-md-7 col-xs-12 quick-field" name="course_id" id="edit_course_id">
                                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                                <?php foreach($courses as $obj){ ?>                                                    
                                                    <option value="<?php echo $obj->id; ?>" <?php if($student->course_id == $obj->id){ echo 'selected="selected"';} ?>><?php echo $obj->name; ?></option>                                                   
                                                <?php } ?>
                                            </select>
                                            <div class="help-block"><?php echo form_error('course_id'); ?></div>
                                         </div>
...
<div class="modal fade bs-print-modal-lg" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">        
        <div class="modal-body fn_print_data" id='fn_print_data'>
...
<script type="text/javascript">        
    function get_student_modal(student_id){
        ...
        $.ajax({       
          type   : "POST",
          url    : "<?php echo site_url('student/subscriptions/get_single_student'); ?>",
    ...
    function get_print_modal(student_id){
         ...
         $.ajax({       
           type   : "POST",
           url    : "<?php echo site_url('student/subscriptions/get_single_student_print'); ?>",
           data   : {student_id : student_id},  
           success: function(response){                                                   
              if(response)
              {
     ...
     function move_admint_student(id){
        $.ajax({       
            type   : "POST",
            url    : "<?php echo site_url('student/subscriptions/move_admint_student'); ?>",
            data   : { student_id:id},               
            success: function(response){ 
                var data=JSON.parse(response);
                if(data.meassage=="sucess")
                { 
                    console.log("student/edit/"+data.student_id);
                    window.open("student/edit/"+data.student_id);
                }else{
                    alert("fail!");
                }
            }
