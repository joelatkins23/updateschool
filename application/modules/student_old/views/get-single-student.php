        ...
        <div  class="tab-pane fade in active" id="tab_basic_info" >               
            <table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                <tbody>
                    ...
                    <tr>
                        <th><?php echo $this->lang->line('provincial').' '. $this->lang->line('sector'); ?></th>
                        <td><?php echo $student->provincial_sector_name; ?></td>
                        <th><?php echo $this->lang->line('date_of_national_id'); ?></th>
                        <td><?php echo $student->date_of_national_id; ?></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <?php if ($guardian->photo) { ?>
                                <?php if ($CheckGuardian=='10000') { ?>
                                    <img src="<?php echo UPLOAD_PATH; ?>/student-photo/<?php echo $guardian->photo; ?>" alt="" width="70" /><br/><br/>
                                <?php }else{ ?>
