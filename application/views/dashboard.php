...
<div class="row ">
    ...
    <?php if(has_permission(VIEW, 'accounting', 'income')){ ?>
        <div class="col-md-3 col-sm-4 col-xs-6 tile_stats_count">
            <div class="stats-count-inner">
                ...
                <div class="count green"><?php echo number_format($total_income ? $total_income : '0.00',2); ?></div>
            </div>
        </div>
     <?php } ?>
    ...
    <div class="col-md-3 col-sm-4 col-xs-6 tile_stats_count">
        <div class="stats-count-inner">
            ...
            <div class="count red"><?php echo number_format($total_expenditure? $total_expenditure : '0.00',2); ?></div>
        </div>
    </div>
     <?php } ?>  
    </div>
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel tile overflow_hidden">
                ...
                <div class="x_content">
                    ...
                    <script type="text/javascript" src='<?php echo VENDOR_URL; ?>fullcalendar/locale/pt-br.js'></script> 
                    <script type="text/javascript">
                        $(function () {
    ...
    <div class="col-md-4 col-sm-4 col-xs-12">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h4 class="head-title"><?php echo $this->lang->line('type'); ?> de <?php echo $this->lang->line('user'); ?> </h4>
                        <ul class="nav navbar-right panel_toolbox">
                            <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a> </li>
                        </ul>
                        <div class="clearfix"></div>
