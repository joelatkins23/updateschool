            ...
            <div class="menu_section">
                ...
                <ul class="nav side-menu">                    
                    ...
                    <?php if(has_permission(VIEW, 'student', 'type') || 
                            ...
                            has_permission(ADD, 'student', 'manage_canceled') ||
                               ...
                               <ul class="nav child_menu">
                                    ...
                                    <?php if(has_permission(VIEW, 'student', 'student')){ ?>
                                     ...
                                     <?php if(has_permission(VIEW, 'student', 'manage_canceled')){ ?>
                                        <li><a href="<?php echo site_url('student/manage_canceled/index'); ?>"> <?php echo $this->lang->line('manage'); ?> <?php echo $this->lang->line('canceled'); ?></a></li>
                                     <?php } ?> 
                        ...
                        <li><a><i class="fa fa-file-text-o"></i> <?php echo $this->lang->line('exam_mark'); ?> <span class="fa fa-chevron-down"></span></a>
                            <ul class="nav child_menu">
                                ...
                                <?php if(has_permission(VIEW, 'exam', 'aptitudenote')){ ?>
                                    <li><a href="<?php echo site_url('exam/aptitudenote/index'); ?>"><?php echo $this->lang->line('aptitude'); ?> <?php echo $this->lang->line('note'); ?></a></li>
                                <?php } ?>
                        ...
                        <li><a><i class="fa fa-calculator"></i> <?php echo $this->lang->line('accounting'); ?> <span class="fa fa-chevron-down"></span></a>
                            <ul class="nav child_menu">
                                <?php if(has_permission(VIEW, 'accounting', 'studentpayment')){ ?>
                                    <li><a href="<?php echo site_url('accounting/studentpayment'); ?>"><?php echo $this->lang->line('student'); ?> <?php echo $this->lang->line('payment'); ?></a></li> 
                                <?php } ?>
                                <?php if(has_permission(VIEW, 'accounting', 'studentpaymentuser')){ ?>
                                    <li><a href="<?php echo site_url('accounting/studentpaymentuser'); ?>"><?php echo $this->lang->line('student'); ?> <?php echo $this->lang->line('user'); ?>  <?php echo $this->lang->line('payment'); ?></a></li> 
                                <?php } ?>
                                <?php if(has_permission(VIEW, 'accounting', 'studentpaymentday')){ ?>
                                    <li><a href="<?php echo site_url('accounting/studentpaymentday'); ?>"><?php echo $this->lang->line('student'); ?>  <?php echo $this->lang->line('day'); ?>  <?php echo $this->lang->line('payment'); ?></a></li> 
                                <?php } ?>
                               <?php if(has_permission(VIEW, 'accounting', 'discount')){ ?>
                    ...
                    <?php if(has_permission(VIEW, 'report', 'report')){ ?>
                        <li><a><i class="fa fa-bar-chart"></i> <?php echo $this->lang->line('report'); ?> <span class="fa fa-chevron-down"></span></a>
                            <ul class="nav child_menu">
                                ...
                                <li><a href="<?php echo site_url('report/listsubscriptions'); ?>"><?php echo $this->lang->line('list'); ?> <?php echo $this->lang->line('subscriptions'); ?> <?php echo $this->lang->line('report'); ?></a></li> 
                                <li><a href="<?php echo site_url('report/listadmit'); ?>"><?php echo $this->lang->line('list'); ?> <?php echo $this->lang->line('admit'); ?> <?php echo $this->lang->line('report'); ?></a></li> 
                                ...
                                <li><a href="<?php echo site_url('report/studentdailypayment'); ?>"><?php echo $this->lang->line('student'); ?> <?php echo $this->lang->line('daily'); ?> <?php echo $this->lang->line('payment'); ?></a></li> 
                                <li><a href="<?php echo site_url('report/studentnotpayment'); ?>"><?php echo $this->lang->line('student'); ?> <?php echo $this->lang->line('not'); ?> <?php echo $this->lang->line('payment'); ?></a></li> 
                                <li><a href="<?php echo site_url('report/studentagepayment'); ?>"><?php echo $this->lang->line('student'); ?> <?php echo $this->lang->line('age'); ?> <?php echo $this->lang->line('payment'); ?></a></li> 
