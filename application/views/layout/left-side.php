            ...
            <div class="menu_section">
                ...
                <ul class="nav side-menu">                    
                    ...
                    if(has_permission(VIEW, 'administrator', 'setting') ||
                            ...
                            has_permission(VIEW, 'administrator', 'product') || 
                            has_permission(VIEW, 'administrator', 'course') || 
                        ...
                        <li><a><i class="fa fa-user"></i> <?php echo $this->lang->line('administrator'); ?> <span class="fa fa-chevron-down"></span></a>
                            <ul class="nav child_menu">
                                ...
                                <?php if(has_permission(VIEW, 'administrator', 'product')){ ?>   
                                    <li><a href="<?php echo site_url('administrator/product'); ?>"> <?php echo $this->lang->line('manage_product'); ?></a></li>
                                <?php } ?>
                                <?php if(has_permission(VIEW, 'administrator', 'course')){ ?>   
                                    <li><a href="<?php echo site_url('administrator/course'); ?>"><?php echo $this->lang->line('manage'); ?> <?php echo $this->lang->line('course'); ?></a> </li> 
                                <?php } ?>
                    ...
                    <?php if(has_permission(VIEW, 'student', 'type') || 
                            ...
                            has_permission(ADD, 'student', 'subscriptions') ||
                           ...
                           <li><a><i class="fa fa-group"></i> <?php echo $this->lang->line('student'); ?> <span class="fa fa-chevron-down"></span></a>
                               <ul class="nav child_menu">
                                    ...
                                    <?php if(has_permission(VIEW, 'student', 'student')){ ?>
                                        <li><a href="<?php echo site_url('student/index'); ?>"> <?php echo $this->lang->line('manage'); ?> <?php echo $this->lang->line('admit'); ?></a></li>
                                     <?php } ?> 
                                     <?php if(has_permission(ADD, 'student', 'subscriptions')){ ?>
                                        <li><a href="<?php echo site_url('student/subscriptions/index'); ?>"> <?php echo $this->lang->line('manage'); ?> <?php echo $this->lang->line('subscriptions'); ?> </a></li>
                                    <?php } ?>
                                    <?php if(has_permission(ADD, 'student', 'student')){ ?>
                                        <li><a href="<?php echo site_url('student/add/'); ?>"> <?php echo $this->lang->line('admit'); ?>r</a></li>
                                     <?php } ?> 
                                    <?php if(has_permission(ADD, 'student', 'bulk')){ ?>
                                         <li><a href="<?php echo site_url('student/bulk/add'); ?>"> Importar <?php echo $this->lang->line('admission'); ?></a></li>
                                    <?php } ?> 
                                    <?php if(has_permission(VIEW, 'student', 'admission')){ ?>
                                         <li><a href="<?php echo site_url('student/admission/index'); ?>"> <?php echo $this->lang->line('admission'); ?> <?php echo $this->lang->line('online'); ?> </a></li>
                                    <?php } ?> 
                                    <?php if(has_permission(VIEW, 'student', 'manage_canceled')){ ?>
                                        <li><a href="<?php echo site_url('student/manage_canceled/index'); ?>"> <?php echo $this->lang->line('manage'); ?> Anulados</a></li>
                                     <?php } ?>
                            ...
                            <li><a><i class="fa fa-group"></i> <?php echo $this->lang->line('student'); ?> <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    <?php if(has_permission(ADD, 'student', 'type')){ ?>
                                        <li><a href="<?php echo site_url('student/type/index'); ?>"> <?php echo $this->lang->line('type'); ?> de <?php echo $this->lang->line('student'); ?>  </a></li>
                                    <?php } ?>
                                    ...
                                    <?php } ?>
                                    <?php if(has_permission(ADD, 'student', 'subscriptions')){ ?>
                                        <li><a href="<?php echo site_url('student/subscriptions/index'); ?>">  <?php echo $this->lang->line('subscriptions'); ?> </a></li>
                                    <?php } ?>
                                    <?php if(has_permission(ADD, 'student', 'bulk')){ ?>
                                         <li><a href="<?php echo site_url('student/bulk/add'); ?>"> Inportar <?php echo $this->lang->line('admission'); ?></a></li>
                                    <?php } ?>     
                                    <?php if(has_permission(VIEW, 'student', 'admission')){ ?>
                                         <li><a href="<?php echo site_url('student/admission/index'); ?>"><?php echo $this->lang->line('admission');?> <?php echo $this->lang->line('online'); ?> </a></li>
                                    <?php } ?>
                                    <?php if(has_permission(VIEW, 'student', 'manage_canceled')){ ?>
                                        <li><a href="<?php echo site_url('student/manage_canceled/index'); ?>"><?php echo $this->lang->line('admit'); ?> Anuladas</a></li>
                                     <?php } ?>     
                                    <?php foreach($classes as $obj){ ?>
                    ...
                    <?php if(has_permission(VIEW, 'exam', 'attendance')){ ?>
                        <li><a  href="<?php echo site_url('exam/attendance/'); ?>"><i class="fa fa-check"></i><?php echo $this->lang->line('attendance'); ?> <?php echo $this->lang->line('exam'); ?> </a></li>
                    <?php } ?>    
                    <?php if(has_permission(VIEW, 'exam', 'attendance')){ ?>
                        <li><a  href="<?php echo site_url('report/listadmissao'); ?>"><i class="fa fa-check"></i> <?php echo $this->lang->line('attendance'); ?> <?php echo $this->lang->line('exam'); ?> Admissão </a></li>
                    <?php } ?>
                        
                       <?php if(has_permission(VIEW, 'exam', 'mark') || 
                               has_permission(VIEW, 'exam', 'examresult') || 
                               has_permission(VIEW, 'exam', 'aptitudenote') || 
                        ...
                        <li><a><i class="fa fa-file-text-o"></i> <?php echo $this->lang->line('exam_mark'); ?> <span class="fa fa-chevron-down"></span></a>
                            <ul class="nav child_menu">
                                ...
                                <?php } ?>
                                <?php if(has_permission(VIEW, 'exam', 'aptitudenote')){ ?>
                                    <li><a href="<?php echo site_url('exam/aptitudenote/index'); ?>"><?php echo $this->lang->line('exam'); ?> <?php echo $this->lang->line('aptitude'); ?> </a></li>
                                <?php } ?>
                                <?php if(has_permission(VIEW, 'exam', 'examresult')){ ?>
                                    <li><a href="<?php echo site_url('exam/examresult/index'); ?>"><?php echo $this->lang->line('result'); ?> <?php echo $this->lang->line('exam_term'); ?> </a></li>
                                <?php } ?>
                   ...
                   <?php } ?>
                    ...
                    <?php if(has_permission(VIEW, 'accounting', 'discount') || 
                            ...
                            has_permission(VIEW, 'accounting', 'studentpayment') || 
                            has_permission(VIEW, 'accounting', 'studentpaymentuser') || 
                            has_permission(VIEW, 'accounting', 'studentpaymentday') || 
                        ...
                        <li><a><i class="fa fa-calculator"></i> <?php echo $this->lang->line('accounting'); ?> <span class="fa fa-chevron-down"></span></a>
                            <ul class="nav child_menu">
                                <?php if(has_permission(VIEW, 'accounting', 'studentpayment')){ ?>
                                    <li><a href="<?php echo site_url('accounting/studentpayment'); ?>"> <?php echo $this->lang->line('payment'); ?></a></li> 
                                <?php } ?>
                                <?php if(has_permission(VIEW, 'accounting', 'studentpaymentuser')){ ?>
                                    <li><a href="<?php echo site_url('accounting/studentpaymentuser'); ?>">Extracto <?php echo $this->lang->line('user'); ?></a></li> 
                                <?php } ?>
                                <?php if(has_permission(VIEW, 'accounting', 'studentpaymentday')){ ?>
                                    <li><a href="<?php echo site_url('accounting/studentpaymentday'); ?>"> Extracto <?php echo $this->lang->line('student'); ?></a></li> 
                                <?php } ?>
                               <?php if(has_permission(VIEW, 'accounting', 'discount')){ ?>
                    ...
                    <?php if(has_permission(VIEW, 'report', 'report')){ ?>
                        <li><a><i class="fa fa-bar-chart"></i> <?php echo $this->lang->line('report'); ?> <span class="fa fa-chevron-down"></span></a>
                            <ul class="nav child_menu">
                                <li><a href="<?php echo site_url('report/studentdailypayment'); ?>"><?php echo 'Movimento'; ?> Diário</a></li> 
                                <li><a href="<?php echo site_url('report/studentnotpayment'); ?>"><?php echo $this->lang->line('tuition'); ?> <?php echo $this->lang->line('not'); ?> Paga</a></li> 
                                <li><a href="<?php echo site_url('report/listsubscriptions'); ?>"><?php echo $this->lang->line('list'); ?> <?php echo $this->lang->line('subscriptions'); ?> </a></li> 
                                <li><a href="<?php echo site_url('report/listadmit'); ?>"><?php echo $this->lang->line('list'); ?> <?php echo $this->lang->line('admit'); ?> </a></li> 
                                ...
                                <li><a href="<?php echo site_url('report/feecollection'); ?>"><?php echo $this->lang->line('fee'); ?> <?php echo $this->lang->line('report'); ?> <?php echo $this->lang->line('collection'); ?> </a></li>
                                <li><a href="<?php echo site_url('report/balance'); ?>"><?php echo $this->lang->line('accounting'); ?> <?php echo $this->lang->line('report'); ?> <?php echo $this->lang->line('balance'); ?> </a></li> 
                                ...
                                <li><a href="<?php echo site_url('report/syattendance'); ?>"><?php echo $this->lang->line('student'); ?> <?php echo $this->lang->line('attendance'); ?> <?php echo $this->lang->line('yearly'); ?> </a></li>
                                <li><a href="<?php echo site_url('report/tattendance'); ?>"><?php echo $this->lang->line('teacher'); ?> <?php echo $this->lang->line('attendance'); ?></a></li>
                                <li><a href="<?php echo site_url('report/tyattendance'); ?>"><?php echo $this->lang->line('teacher'); ?> <?php echo $this->lang->line('attendance'); ?> <?php echo $this->lang->line('yearly'); ?> </a></li>
                                ...
                                <li><a href="<?php echo site_url('report/studentagepayment'); ?>"><?php echo $this->lang->line('list'); ?> <?php echo $this->lang->line('subscriptions'); ?> Por <?php echo $this->lang->line('age'); ?> </a></li> 
                                ...
                                <li><a href="<?php echo site_url('report/transaction'); ?>"><?php echo $this->lang->line('daily'); ?> <?php echo $this->lang->line('report'); ?> <?php echo $this->lang->line('transaction'); ?> </a></li>
